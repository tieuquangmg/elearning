...
//    'middleware' => ['role:student|teacher'],
    Route::group(['prefix' => 'study', 'middleware' => ['auth']], function(){
        Route::get('sub/{id}', 'StudyController@getSubject')->name('study.subject')->middleware('updateforum');
...
//ket qua hoc tap
        ...
        Route::get('ket-qua-kiem-tra/{class_id}/{id}', 'StudyController@getKetQuaKiemTra')->name('study.ketquakiemtra');
//////////////////////
...
// tin nhan, thong bao
    ...
    Route::group(['prefix' => 'study', 'middleware' => ['auth','nguoidung']], function () {
//Giáo viên ///////////////////////////
    ...
    Route::group(['middleware' => 'nguoidung'],function () {
        Route::get('/admin', function () {
            ...
            $time->addSeconds(15);
            $data['messages'] = \App\Modules\Media\Models\Message::get_to_user_id(Auth::guard('nguoidung')->user()->id)->get();
//            $data['messages'] = \App\Modules\Auth\Models\Nguoidung::find(Auth::guard('nguoidung')->user()->id)->message;
//            dd($data);
...
Route::group(['middleware' => 'nguoidung'], function () {
    Route::get('nguoi_dung/logout', 'Nguoidung\AuthController@getLogout');
    Route::get('nguoi_dung/dashboard', 'App\Modules\Auth\Controllers\NguoidungController@getIndex');
});
Route::get('nguoi_dung/login', 'Nguoidung\AuthController@getLogin');
Route::post('nguoi_dung/login', 'Nguoidung\AuthController@postLogin');
Route::get('nguoi_dung/register', 'Nguoidung\AuthController@getRegister');
Route::post('nguoi_dung/register', 'Nguoidung\AuthController@postRegister');
