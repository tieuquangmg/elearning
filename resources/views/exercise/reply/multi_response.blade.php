...
<table class="table table-bordered table-responsive table-striped">
    <tr >
        ...
        <th style="width: 5%"><a class="btn btn-primary btn-xs btn-block" id="add_reply_multi_response"><span class="glyphicon glyphicon-plus"></span></a></th>
    </tr>

    <tbody id="table_content">
    @for($i=0; $i<3;$i++)
        <tr class="text-center">
            <td ><input type="checkbox" name="answer[]" value="{{$i}}"></td>
