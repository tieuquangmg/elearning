...
@section('content')
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('news.data')}}">Lớp</a></li>
        <li class="active">Tất cả Lớp</li>
    </ol>
    @if(count($data)>0)
        <div class="form-group text-right">
            <a class="btn btn-sm btn-primary" href="{{route('news.create')}}"><span class="glyphicon glyphicon-plus-sign"> </span>Thêm lớp mới</a>
            <a id="delete" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"> </span>Xóa lớp</a>
        </div>
        <table class="table">
            <tr>
