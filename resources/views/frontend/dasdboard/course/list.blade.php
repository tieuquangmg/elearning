                                        ...
                                        <a href="#">
                                            ...
                                            <figure class="block_my_profile_bginfo2">
                                                <div class="block_my_profile_textvl2">
                                                    <i class="fa fa-pencil-square-o fa-2x"><br><span style="font-family: Arial; font-size: 14px; font-style: normal; font-variant: normal; line-height: 20px;">Xem thông tin cá nhân</span></i>
                                                </div>
                                            </figure>
                                        </a>
                                    </div>
                                    ...
                                    <ul class="block_my_courses_list-unstyled">
                                        @foreach($classes as $row)
                                            <li class="block_my_courses_litext-tpc">
                                                <a title="{{$row->name}}" href="{{route('study.subject',$row)}}">{{$row->name}}</a>
                                            </li>
                                            @endforeach
                                    </ul>
                                </div>
