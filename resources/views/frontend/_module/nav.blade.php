    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a class="page-scroll" href="#services">Hệ thống</a>
                </li>
                <li>
                ...
                <li>
                    <a class="page-scroll" href="#team">Nhóm phát triển</a>
                </li>
                <li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @if(auth()->check())
                <li>
                    <a href="#shoppingCartModal" class="portfolio-link" data-toggle="modal"><span class="fa fa-shopping-cart"></span> 2</a>
                </li>
                ...
                <li class="dropdown" style="background: transparent">
                    ...
                    <ul class="dropdown-menu" style="background: #2b2b2b; ">
                        <li> <a href=""><span class="fa fa-sign-out" data-toggle="tooltip" data-placement="top" title="Đăng xuất"></span>Đăng xuất</a></li>
                        <li ><a href="#"><span class="fa fa-comments-o"></span>Tin nhắn </a></li>
                        <li ><a href="#"><span class="fa fa-pencil-square-o"></span> Lớp </a></li>
                        <li ><a href="{{route('profile.index')}}"><span class="fa fa-user-secret"></span> Thông tin cá nhân </a></li>
                    </ul>
                </li>
                @else
