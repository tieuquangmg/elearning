            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/nguoi_dung/login') }}">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                                <label class="col-md-4 control-label">mã giáo viên </label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="name" value="{{ old('name')}}" placeholder="1417012">
                                    @if ($errors->has('code'))
                                        <span class="help-block">
